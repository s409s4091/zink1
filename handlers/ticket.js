    ...
    guild.channels.create(channelname.substring(0, 31), optionsData).then(async ch => {
      ...
      if (ticket.claim.enabled) {
        var claimEmbed = new MessageEmbed()
          ...
          .setAuthor(client.getAuthor(`A Staff Member will claim the Ticket soon!`, "https://cdn.discordapp.com/emojis/833101350623117342.gif?size=44", "https://discord.gg/https://sites.google.com/view/zink-bot/home?pli=1"))
