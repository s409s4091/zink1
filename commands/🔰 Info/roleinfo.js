  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {   
      ...
      if(!role || role == null || role.id == null || !role.id) return message.reply(client.la[ls].common.rolenotfound)
        ...
        embeduserinfo.setAuthor(client.la[ls].cmds.info.roleinfo.author + " " + role.name, message.guild.iconURL({ dynamic: true }), "https://discord.gg/https://sites.google.com/view/zink-bot/home?pli=1")
