  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      translate(args.slice(2).join(" "), {from: args[0], to: args[1]}).then(res=>{
        ...
        .setColor(es.color)
        .setAuthor(handlemsg(client.la[ls].cmds.info.translate.to, { to: args[1] }), "https://imgur.com/0DQuCgg.png", "https://discord.gg/https://sites.google.com/view/zink-bot/home?pli=1")
