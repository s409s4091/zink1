   ...
   run: async (client, message, args, cmduser, text, prefix) => {
     ...
     try {
      ...
      return message.reply({embeds : [new MessageEmbed()
       ...
       var members = message.guild.members.cache.filter(member => member.user.bot && member.roles.cache.has(role.id)).map(this_Code_is_by_S409_6966 => this_Code_is_by_S409_6966);
