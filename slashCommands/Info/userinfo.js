    ...
    try{
		...
		try {   
		  ...
		  try{
			...
			embeduserinfo.setAuthor(handlemsg(client.la[ls].cmds.info.userinfo.author, { usertag: member.user.tag}), member.user.displayAvatarURL({ dynamic: true }), "https://discord.gg/https://sites.google.com/view/zink-bot/home?pli=1")
			...
			embeduserinfo.setAuthor(handlemsg(client.la[ls].cmds.info.userinfo.author, { usertag: user.tag}), user.displayAvatarURL({ dynamic: true }), "https://discord.gg/https://sites.google.com/view/zink-bot/home?pli=1")
