  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try {   
      ...
      if(!role || role == null || role.id == null || !role.id) return interaction?.reply(client.la[ls].common.rolenotfound)
        ...
        embeduserinfo.setAuthor(client.la[ls].cmds.info.roleinfo.author + " " + role.name, guild.iconURL({ dynamic: true }), "https://discord.gg/https://sites.google.com/view/zink-bot/home?pli=1")
