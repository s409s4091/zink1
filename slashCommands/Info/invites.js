  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try{
      ...
      interaction?.reply({ephemeral: true, embeds: [new Discord.MessageEmbed()
        .setAuthor(handlemsg(client.la[ls].cmds.info.invites.author, {usertag: user.tag}), user.displayAvatarURL({dynamic: true}), "https://discord.gg/https://sites.google.com/view/zink-bot/home?pli=1")
